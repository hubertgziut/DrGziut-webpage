    ...
    <SectionBackground id="doctor" src="/assets/brand/clinic-1.jpg">
      <section className="section">
        <div className="container split">
          <Reveal><div className="img-panel" style={{ aspectRatio: '4 / 5', maxHeight: 650 }}><img src={assetUrl('/assets/brand/doctor.png')} loading="lazy" decoding="async" alt={t({ pl: 'Dr Hubert Gziut — specjalista chirurgii plastycznej', en: 'Dr Hubert Gziut — plastic surgery specialist' })} /></div></Reveal>
